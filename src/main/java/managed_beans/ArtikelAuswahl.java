...
public class ArtikelAuswahl extends ManagedBean {
    ...
    public String artikelInKonfiguratorLaden() {
        String artikelIdentifier = getRequestParameter("ArtikelIdentifier");
        return "";
    }
}
